odoo.define('hfb_baselinker_api.add_product', function (require) {
'use strict';
...
odoo.define('hfb_baselinker_api.editMenu', function (require) {
    'use strict';
...
odoo.define('hfb_baselinker_api.editor', function (require) {
'use strict';
...
options.registry.WebsiteSaleProductsItem = options.Class.extend({
    xmlDependencies: (options.Class.prototype.xmlDependencies || []).concat(['/hfb_baselinker_api/static/src/xml/website_sale_utils.xml']),
    ...
    async _renderCustomXML(uiFragment) {
        ...
        Object.values(this.ribbons).forEach(ribbon => {
            const colorClasses = ribbon.html_class
                ...
                .join(' ');
            $select.append(qweb.render('hfb_baselinker_api.ribbonSelectItem', {
                ribbon,
                colorClasses,
